...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarBrandNameAndModelByRentPriceDailyMax")]
        public async Task<IActionResult> GetCarBrandNameAndModelByRentPriceDailyMax()
        {
            var values = await _mediator.Send(new GetCarBrandNameAndModelByRentPriceDailyMaxQuery());
            return Ok(values);
        }

        [HttpGet("GetCarBrandNameAndModelByRentPriceDailyMin")]
        public async Task<IActionResult> GetCarBrandNameAndModelByRentPriceDailyMin()
        {
            var values = await _mediator.Send(new GetCarBrandNameAndModelByRentPriceDailyMinQuery());
            return Ok(values);
        }

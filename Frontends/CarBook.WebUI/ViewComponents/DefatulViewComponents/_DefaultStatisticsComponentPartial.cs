...
namespace CarBook.WebUI.ViewComponents.DefatulViewComponents
{
    public class _DefaultStatisticsComponentPartial:ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            #region İstatistik3
            var responseMessage3 = await client.GetAsync("https://localhost:7182/api/Statistics/GetBrandCount/");
            ...
            #region İstatistik4
            var responseMessage4 = await client.GetAsync("https://localhost:7182/api/Statistics/GetCarCountByFuelElectric/");
